function Plotting_Atlas(fdr_region_significant,t_region,slice,coordinate,subplot_title,n_rows,n_columns,n_subplot)
...
% CerebrA region is significant
% t_region: t statistics values of the CerebrA regions
...
% if n_subplot==3;title('Brain Pattern');end
load Atlas.mat % loads CerebrA and ICBM information
...
hold off;set(f, 'AlphaData', (rot90(z_p_seg)~=0)*transparency);title(subplot_title)
end